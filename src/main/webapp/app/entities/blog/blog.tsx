...
export const Blog = (props: IBlogProps) => {
  ...
  return (
    <div>
      <h2 id="blog-heading">
        <Translate contentKey="monolithApp.blog.home.title">Blogs</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="monolithApp.blog.home.createLabel">Create new Blog</Translate>
        </Link>
      </h2>
        ...
        {blogList && blogList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="monolithApp.blog.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="monolithApp.blog.handle">Handle</Translate>
                </th>
                <th>
                  <Translate contentKey="monolithApp.blog.user">User</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="monolithApp.blog.home.notFound">No Blogs found</Translate>
            </div>
          )
        )}
      </div>
