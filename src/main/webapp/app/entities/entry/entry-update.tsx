  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="monolithApp.entry.home.createOrEditLabel">
            <Translate contentKey="monolithApp.entry.home.createOrEditLabel">Create or edit a Entry</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : entryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="titleLabel" for="entry-title">
                  <Translate contentKey="monolithApp.entry.title">Title</Translate>
                </Label>
                <AvField
                  id="entry-title"
                  type="text"
              ...
              <AvGroup>
                <Label id="contentLabel" for="entry-content">
                  <Translate contentKey="monolithApp.entry.content">Content</Translate>
                </Label>
                <AvInput
                  id="entry-content"
                  type="textarea"
              ...
              <AvGroup>
                <Label id="dateLabel" for="entry-date">
                  <Translate contentKey="monolithApp.entry.date">Date</Translate>
                </Label>
                <AvInput
                  id="entry-date"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label for="entry-blog">
                  <Translate contentKey="monolithApp.entry.blog">Blog</Translate>
                </Label>
                <AvInput id="entry-blog" type="select" className="form-control" name="blogId">
                  <option value="" key="0" />
                  {blogs
              ...
              <AvGroup>
                <Label for="entry-tag">
                  <Translate contentKey="monolithApp.entry.tag">Tag</Translate>
                </Label>
                <AvInput
                  id="entry-tag"
                  type="select"
