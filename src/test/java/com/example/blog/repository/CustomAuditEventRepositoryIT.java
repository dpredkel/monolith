...
import com.example.blog.MonolithApp;

import com.example.blog.config.Constants;
import com.example.blog.config.TestSecurityConfiguration;
import com.example.blog.config.audit.AuditEventConverter;
import com.example.blog.domain.PersistentAuditEvent;
...
import static com.example.blog.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

/**
 * Integration tests for {@link CustomAuditEventRepository}.
 */
@SpringBootTest(classes = {MonolithApp.class, TestSecurityConfiguration.class})
@Transactional
